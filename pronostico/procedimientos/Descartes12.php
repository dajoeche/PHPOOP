...
class Descartes12
{
  ...
  public $limiteEnjauladoDiario2=2;
  ...
  public $listado=array(array('1','11','21','31','00'),
    ...
    function __construct($fecha, $loteria, $sorteo) { 
		...
		$this->color='negro';
		$this->enjaula2 = new EnjauladosDiario2($this->fecha, $this->loteria,$this->sorteo,$this->limiteEnjauladoDiario2);;
		$this->iterarArray($this->enjaula2->tabla);		
