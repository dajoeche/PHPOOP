...
class Sorteos3 extends  Sorteos
{
  use MArray;
  use Utilitario;
  ...
  public $encabezadoTabla =  array(array("Sorteo"));
    ...
    function __construct($fecha, $loteria, $animal, $animal2, $animal3) {
		$this->fecha=$fecha;
		$this->loteria=$loteria;
		$this->miNumero=$animal;
		$this->miNumero2=$animal2;
		$this->miNumero3=$animal3;
		$this->crearObjeto();		      
    }  
	...
	public function agregarSorteos($resultado) {
		...
		if ($resultado[1] === $this->miNumero3){
			$this->tabla[]= array($resultado[0],array("dato"=>$resultado[1],"atributos"=>array("class"=>"gris")));	
		}
				
		if ($resultado[1] <> $this->miNumero and $resultado[1] <> $this->miNumero2 and $resultado[1] <> $this->miNumero3){
